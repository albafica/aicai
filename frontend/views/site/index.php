...
<div class="container">
        ...
        <div class="content">
            ...
            <div class="card_box row">
                <div class="card col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <img src="images/rd.png" class="card_icon" alt="技术">
                    <p>技术</p>
                ...
                <div class="card col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <img src="images/rd.png" alt="设计师" class="card_icon">
                    <p>设计师</p>
                    <form action="http://db.jobdeer.com/?a=resume_save_new" method="post" enctype="multipart/form-data" >
                        <paper-button class="btn  btn-lg btn-primary ">上传简历</paper-button>
                ...
                <div class="card col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <img src="images/rd.png" alt="产品经理" class="card_icon">
                    <p>产品经理</p>
                    <form action="http://db.jobdeer.com/?a=resume_save_new" method="post" enctype="multipart/form-data" >
                        <paper-button class="btn  btn-lg btn-primary ">上传简历</paper-button>
                ...
                <div class="card col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <img src="images/rd.png" alt="运营" class="card_icon">
                    <p>产品运营</p>
                    <form action="http://db.jobdeer.com/?a=resume_save_new" method="post" enctype="multipart/form-data" >
                        <paper-button class="btn  btn-lg btn-primary "> 上传简历</paper-button>
    ...
    <div class="step">
        ...
        <div class="content">
            ...
            <div class="jd-card">
                <div  class="clearfix">
                    <img src="images/heping.png" width="150" height="150" desktop="" class="mr40 mt13 pull-left">
                    <div flex="" class="f24">
                    ...
                    <div class="mb20 row">
                        ...
                        <div class="row">
                            <div class="company mt10">
                                <div class="logo"><a href="http://www.sina.com.cn/" target="_blank"><img src="images/logos/sina.png"></a></div>
                            ...
                            <div class="company mt10">
                                <div class="logo"><a href="http://www.sina.com.cn/" target="_blank"><img src="images/logos/liebao.png"></a></div>
